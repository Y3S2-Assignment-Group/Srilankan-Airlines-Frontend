...
class _checkinState extends State<checkin> {
  ...
  void initState() {
    ...
    currentTrip = context.read<UserProvider>().getCurrentTrip();
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Text(
                            currentTrip.getflight().id.substring(0, 4),
                            style: TextStyle(
